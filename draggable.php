...
<head>
  ...
  $( function() {
    ...
    var coordinatesDesk = function(elementDesk) {
    elementDesk = $(elementDesk);
    var topDesk = elementDesk.position().top;
    var leftDesk = elementDesk.position().left;
    posDesk.innerHTML = 'Desk - X: ' + leftDesk + ' ' + 'Y: ' + topDesk+"\n";
...
<body onload="myLoadHeader()">
  ...
  <div id="icons">
    <!-- ikony zostaną dodane dynamicznie przez JQuery -->
  </div>
</div>
